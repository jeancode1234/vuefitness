<template>
  <div style="font-family: Georgia, 'Times New Roman', Times, serif">
    <div class="w-full h-screen p-4 md:p-0 overflow-hidden flex items-center justify-center ">
      ...
      <div class="w-full md:w-1/2 h-full flex items-center flex-col justify-center bg-white">
        <h1 class="text-3xl font-extrabold text-black uppercase">dim<span class="text-red-800">fitness</span></h1>
        <h2 class="text-center text-2xl text-gray-800 pb-8">Connexion à votre compte</h2>
        <form @submit.prevent="login" class=" w-full">
          <div class="w-full sm:px-8 lg:px-20">
            <div class="w-full">
            ...
            <div class=" space-y-8">
              <div class="w-full relative flex items-center">
                ...
                <input type="email" name="email" v-model="form.email" placeholder="Entrer votre email" required class="w-full placeholder:text-gray-800 text-gray-800 outline-none border p-3 flex items-center rounded-full border-red-900 bg-transparent" />
              </div>
              <div class="w-full relative flex items-center">
                ...
                <input name="password" v-model="form.password" :type="visibility" placeholder="Mot de passe" required class="w-full placeholder:text-gray-800 text-gray-800 outline-none border p-3 flex items-center rounded-full border-red-900 bg-transparent" />
              </div>
              <div>
                <a href="#" class="hover:text-red-800 text-gray-900">Mot de passe oublié?</a>
              </div>
              <div class="flex flex-col items-center justify-center w-full space-y-4">
                <button type="submit" :disabled="isLoading" class="w-full flex justify-center space-x-2 bg-red-800 hover:bg-red-900 text-white py-3 px-4 rounded-full">
                ...
                <button type="button" @click="loginWithGoogle" class="w-full border space-x-4 hover:bg-red-700 hover:text-white duration-300 flex items-center justify-center border-red-700 text-red-800 font-bold py-2 px-4 rounded-full">
